...
Учёт доходов и расходов с офлайн‑режимом, аналитикой и синхронизацией через локальный API. Готово к быстрому развёртыванию локально, на сервере или на GitHub Pages.
